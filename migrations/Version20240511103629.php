...
/**
 * Add connection table to store likes by users on posts
 */
final class Version20240511103629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE text text VARCHAR(500) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE text text TEXT NOT NULL');
    }
}
